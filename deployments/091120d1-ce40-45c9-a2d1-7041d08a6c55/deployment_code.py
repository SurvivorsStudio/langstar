...
# Deployment ID: 091120d1-ce40-45c9-a2d1-7041d08a6c55
# Generated at: 2025-08-06T00:36:38.706385
...
# 배포 실행 함수 (로컬 실행)
def run_deployment_091120d1_ce40_45c9_a2d1_7041d08a6c55(input_data):
    try:
        result = app.invoke(input_data, {"configurable": {"thread_id": 1}})
        return {
            "success": True,
            "deployment_id": "091120d1-ce40-45c9-a2d1-7041d08a6c55",
            "result": result
        }
    except Exception as e:
        return {
